...
RENAME_SUFFIXES = ("_al_el", "_al_sy", "_al_Shawn")
FINAL_SUFFIX = "_final"
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="rename-subs",
        description="Rename generated subtitle DOCX files from _al_el/_al_sy/_al_Shawn to _final.",
    )
    parser.add_argument(
        "paths",
        nargs="*",
        help=(
            "DOCX files to rename. Default: DOCX files ending in _al_el, _al_sy, or _al_Shawn "
